...
[![Codecov test coverage](https://codecov.io/gh/StatisMike/deepgsheets4/branch/main/graph/badge.svg)](https://app.codecov.io/gh/StatisMike/deepgsheets4?branch=main)
<!-- badges: end -->

The goal of `deepgsheets4` is to provide a low-level access to Google Sheets API, in
opposition to [googlesheets4](https://github.com/tidyverse/googlesheets4){target="_blank"}
package, which provides high-level access. It basically means that `deepgsheets4`
...
You can install the development version of deepgsheets4 from [GitHub](https://github.com/) with:
